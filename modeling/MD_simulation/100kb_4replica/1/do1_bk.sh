...
id2=$2
finalres=$3
statenum=`nl ../../../contact/${finalres}kb_target/contactall/assignall${id1}.dat | tail -n 1 | awk '{print $1}'`
#statenum=`nl ../../assign${id1}.dat | tail -n 1 | awk '{print $1}'`
tail -n $statenum output${id1}.dat > temp.dat

echo -e temp.dat '\n' ../../../contact/${finalres}kb_target/contactall/assignall${id1}.dat '\n' ../../../contact/${finalres}kb_target/contactall/assignall${id2}.dat '\n' conf${id2}.dat | ./insert_contract_assign.o 
